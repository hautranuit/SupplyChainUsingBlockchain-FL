    ...
    */
    contract NFTCore is ERC721URIStorage, Ownable {
        ...
        function mintNFT(
            ...
            string memory productionHistory = "Products are manufactured on ";
            
            emit ProductHistoryUpdated(tokenId, productionHistory); 
            return tokenId;
        }

        function storeCID(uint256 tokenId, string memory cid) public onlyOwner {
        ...
        */
        ...
        function updateProductHistory(uint256 tokenId, string memory cid) public onlyOwner {
            cidMapping[tokenId] = cid;
