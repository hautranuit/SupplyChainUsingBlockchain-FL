...
def create_tff_model_fn(model_name: str, input_shape: int, sample_batch):
    ...
    def model_fn():        # Create uncompiled Keras model
...
def run_federated_learning(args, dirs: Dict[str, str], config: Dict[str, Any]):
    ...
    try:
                    ...
                    try:
                        ...
                        if model_weights is not None:
                            if hasattr(model_weights, 'trainable'):
                                pass # ...existing code for weight transfer...
        ...
        # Kết thúc sau khi train, không thực hiện anomaly detection, response, hay lưu các kết quả liên quan.
