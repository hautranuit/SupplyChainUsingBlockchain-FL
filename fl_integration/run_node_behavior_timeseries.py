...
from tff_advanced_analysis.node_behavior_timeseries.real_data_preparation_node_behavior import make_federated_data_node_behavior_real
...
def main():
    ...
    # Read demo_context.json to get node activity data
    try:
    ...
    try:
        ...
        federated_data = make_federated_data_node_behavior_real(node_data, num_fl_clients=num_clients)
